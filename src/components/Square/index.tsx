...
const Square = ({ crop, code, pen, title, delay }: Props) => {
  ...
  return (
    ...
    >
      <div className="bg-highlight hover:bg-tertiary dark:bg-tertiary dark:hover:bg-highlight hover:text-primary dark:text-white transition duration-300 ease-in-out flex items-center md:items-end p-2 md:p-8 h-full mask-clip-border">
