      ...
      <div className="max-w-xl lg:max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between pt-16 xl:px-0 px-4 ">
        <div className="w-full mt-16 lg:w-1/3 lg:mt-0 ">
          ...
          <Button
            ...
            variant="primary"
            className="mt-4 anim-slide-in-bottom anim-delay-4"
          >
            Get in contact
        ...
        <div className="w-full lg:w-1/2 mt-24 lg:mt-0 ">
          ...
          <p className="flex flex-row md:items-end pt-8 pb-10 lg:pb-0 items-start flex-start anim-slide-in-left anim-delay-4">
            <span className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text text-gradient-right mr-4">{experienceInYears}</span>

            <small className=" mb-6 w-24 text-primary dark:text-white font-serif text-md font-bold">Years of Experience.</small>
            <span className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text text-gradient-right ml-12 mr-4"> 20+</span>
